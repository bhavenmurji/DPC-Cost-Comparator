...
(async () => {
  ...
  try {
    ...
    console.log('\nScreenshots created:');
    console.log('  1. 01-homepage.png - Initial homepage');
    console.log('  2. 02-personal-info.png - Personal information filled');
    console.log('  3. 03-insurance-plan.png - Insurance plan details');
    console.log('  4. 04-healthcare-usage.png - Healthcare usage data');
    console.log('  5. 05-results.png - Cost comparison results');
